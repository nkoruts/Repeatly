...
struct FontBook {
    ...
    static let semibold: Font = .gilroySemiBold(size: 28)
    /// Gilroy-SemiBold, size: 24
    static let semibold2: Font = .gilroySemiBold(size: 24)
    
    /// Gilroy-Medium, size: 20
    static let medium: Font = .gilroyMedium(size: 20)
    /// Gilroy-Medium, size: 18
    static let medium2: Font = .gilroyMedium(size: 18)
    /// Gilroy-Medium, size: 14
    static let medium3: Font = .gilroyMedium(size: 14)
    /// Gilroy-Medium, size: 12
    static let medium4: Font = .gilroyMedium(size: 12)
    
    /// Gilroy-Regular, size: 21
    static let regular: Font = .gilroyRegular(size: 21)
